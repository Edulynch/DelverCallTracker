...
DCT.LOCALES = {
    en = {
        ...
        HIDE_AT_LEVEL_90 = "Hide at level 90",
        HIDE_AT_LEVEL_90_TIP = "Keeps the tracker hidden after reload/relog when your character is level 90 or higher. You can still open it manually.",
    ...
    es = {
        ...
        HIDE_AT_LEVEL_90 = "Ocultar en nivel 90",
        HIDE_AT_LEVEL_90_TIP = "Mantiene el tracker oculto despues de reload/relog cuando tu personaje es nivel 90 o superior. Igual puedes abrirlo manualmente.",
